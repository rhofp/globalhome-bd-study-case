...
alter table cuenta add curp number(18,0);
...
alter table operacion_cuenta add operacion_cuenta_id number(12,0);
...
alter view v_cuenta_movimiento rename column nombre_titular to cuentahabiente;
-- checar si exite nombre_titular en la vista
--falta 9
alter sequence cycle minvalue 15 maxvalue 100000000;
