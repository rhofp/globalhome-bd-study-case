...
--@Descripción: Ejercicio 3: Script encargado de obtener imagenes de los libros.
...
-- en este archivo se guardará el contenido de la columna comando que contiene las 
-- instrucciones para descargar las imágenes. Se hace uso de un spool.
