...
--se otorgan permisos para que el usuario rodrigo0307 de la BD pueda leer
--el contenido del directorio
grant read, write on directory tmp_dir to rodrigo0307;

prompt Contectando con usuario rodrigo0307 para crear la tabla externa
connect rodrigo0307
show user
